       ...
       <li><a href="">Users Online: <?php echo users_online() ?></a></li>
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <i class="fa fa-user"></i> <?php echo $_SESSION['user_firstname'] ." ". $_SESSION['user_lastname'] ?> <b class="caret"></b>
            </a>
        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li <?php if ($active =="users") {?> class="active"<?php } ?>>
                ...
                <ul id="demo" class="collapse">
                    <li <?php if ($active =="viewAllUsers") {?> class="active"<?php } ?>>
                        <a href="users.php">View All Users</a>
                    </li>
                    <li <?php if ($active =="addUser") {?> class="active"<?php } ?>>
                        <a href="users.php?source=add_user">Add User</a>
                    </li>
                </ul>
            </li>
            <li <?php if ($active =="profile") {?> class="active"<?php } ?>>
